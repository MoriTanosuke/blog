---
title: 'Glacier Uploader'
subtitle: 'Java command line client for Amazon Glacier backup'
#date: 2018-06-30 00:00:00
featured_image: '/images/glacier1.jpg'
---

On 23.08.2012 I decided to try out [Amazon Glacier][1] as a backup tool for my files. I keep multiple copies on all my machines
and I own a RAID system to backup inside my rooms, but it's always good to have an external location for your backups. Amazon
introduces *Glacier* as a cheap solution for long-term storage and I simply wanted to put files there even if that meant
...
[0]: https://github.com/MoriTanosuke/glacieruploader/
